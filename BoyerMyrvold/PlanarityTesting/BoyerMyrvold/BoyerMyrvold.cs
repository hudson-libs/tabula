...
using System.Linq;
using tabula.BoyerMyrvold.Graphs.Algorithms;
using tabula.BoyerMyrvold.Graphs.DataStructures;
using tabula.BoyerMyrvold.PlanarityTesting.BoyerMyrvold.Internal;
...
namespace tabula.BoyerMyrvold.PlanarityTesting.BoyerMyrvold
{
	...
	internal class BoyerMyrvold<T>
	{
		...
		public bool TryGetPlanarFaces(IGraph<T> graph, out PlanarFaces<T> faces)
		{
			...
			PlanarFaceTraversal.PlanarFaceTraversal.Traverse(graph, embedding, planarFaceVisitor);
